...
public class MediaBrowserFrame extends JFrame implements ActionListener,
		...
		MouseListener, FocusListener, MediaImportListener, MouseMotionListener {
	...
	public MediaBrowserFrame() {
		...
		if (usesMap) {
			...
			crossHair = new CrosshairMarker(this);
			mapPanel.addCustomMouseMotionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == importMenuItem) {
			...
			if (returnValue == JFileChooser.APPROVE_OPTION) {
				...
				MediaImporter.importFiles(files, this );
				setMode(ApplicationMode.IMPORT);
			}
		}
	...
	public void mediaImportFinished() {
		// TODO Auto-generated method stub
		System.out.println("Finished importing - Medias size: "+MediaManager.getInstance().getMedias().size());
		

		Media media0 = MediaManager.getInstance().getMedias().get(0);
//		Media media = new MediaObject();
//		media.setAuthor("VerdeSolutions");
//		media.setContentImagePath("argiope.jpeg");
//		media.setThumbnailImagePath("argiope_small.jpeg");
//		media.setLatitude(65.014585);
//		media.setLongitude(25.472832);
//		media.setTitle("Church");
		
//		Media media3 = new MediaObject();
//		media.setAuthor("VerdeSolutions");
//		media.setContentImagePath("argiope.jpeg");
//		media.setThumbnailImagePath("argiope_small.jpeg");
//		media3.setLatitude(65.05726081169445);
//		media3.setLongitude(25.47156195283333);
//		media.setTitle("Church");
		
//		this.mapPanel.addMedia(media3);
		this.mapPanel.addMedia(media0);
//		this.mapPanel.addMedia(media);
	}
	...
	public void mouseMoved(MouseEvent evt) {
		double x = evt.getX()/this.mapPanel.getCamera().getViewScale()+this.mapPanel.getCamera().getViewBounds().getOrigin().getX();
		double y = evt.getY()/this.mapPanel.getCamera().getViewScale()+this.mapPanel.getCamera().getViewBounds().getOrigin().getY();
		this.crossHair.moveCrosshair(new Point((int)x, (int)y));
//		if (!crossHair.getCursorHidden()) {
//			BufferedImage cursorImg = new BufferedImage(16, 16, BufferedImage.TYPE_INT_ARGB);
//			Cursor blankCursor = Toolkit.getDefaultToolkit().createCustomCursor(cursorImg, new Point(0, 0), "blank cursor");
//			this.getContentPane().setCursor(blankCursor);
//			crossHair.setCursorHidden(true);
//		}
//		System.out.println("Mouse pos: "+evt.getX()+" "+evt.getY()+" xtr "+this.mapPanel.getCamera().getViewBounds().getOrigin().getX());
	}
